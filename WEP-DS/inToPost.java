...
public class inToPost {
	...
	/**
	 * Evaluates a passed-in postfix statement
	 * @param post String postfix statement
	 * @return	int value of the calculation
	 */
	...
	/**
	 * Converts a passed-in infix statement to post-fix
	 * @param input	infix statement in String form
	 * @return	postfix statement in String form
	 */
