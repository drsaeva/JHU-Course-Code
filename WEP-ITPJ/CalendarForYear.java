...
public class CalendarForYear {
	...
	/**
	 * Gets user input for year, handles invalid inputs, 
	 * 	and prints a calendar for each month in the requested year
	 * @param args
	 */
	public static void main(String[] args) {
		...
		for (int month = 1; month < 13; month++) {
			...
			System.out.println("\n");						// add a pair of trailing newlines for spacing between months
		}
